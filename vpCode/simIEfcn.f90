...
elseif(nlhs .ne. 1) then
	call mexErrMsgTxt('1 output variables required.')
endif
...
call simIEfcnP( %val(mxGetPr(plhs(1))),                                                      &
...
! [simh] = simIEfcnP(kd0, zd0, sx, optK, k, nk, x, nx, z, h, nh, N, Ts, alpha, eta, rhoz, stdz)

subroutine simIEfcnP(simh, kd0, zd0, sx, optK, k, nk, x, nx, z, h, nh, N, Ts, alpha, eta, rhoz, stdz, nz)
